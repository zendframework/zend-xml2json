...
class Xml2JsonTest extends TestCase
{
...
EOT;
        ...
        $jsonContents = Xml2Json::fromXml($xmlStringContents, true);

        // Convert the JSON string into a PHP array.
        $phpArray = Json::decode($jsonContents, Json::TYPE_ARRAY);
...
EOT;
        ...
        $jsonContents = Xml2Json::fromXml($xmlStringContents, false);
...
EOT;
    ...
    /**
     * @group ZF-11385
     * @expectedException Zend\Xml2Json\Exception\RecursionException
